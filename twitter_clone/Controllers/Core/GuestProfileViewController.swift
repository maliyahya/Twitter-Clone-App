...
//  twitter_clone
//
//  Created by Muhammet Ali Yahyaoğlu on 16.01.2024.
//
...
class GuestProfileViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        viewModel.retrieveUser(id: currentUserid)
    }
...
extension GuestProfileViewController:UITableViewDelegate,UITableViewDataSource{
